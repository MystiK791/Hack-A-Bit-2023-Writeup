...
As it turns out, two completely different ASCII values were capable of returning the same chunk data! Knowing this, I adjusted the range of `bruteForceAscii()` to begin at ASCII value 95 (the lowest possible ASCII value for any text in the flag) and end at 127.
